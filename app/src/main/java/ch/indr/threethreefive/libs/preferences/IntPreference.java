...
public class IntPreference implements IntPreferenceType {
  ...
  private IntPreference(final @NonNull SharedPreferences sharedPreferences, final @NonNull String key,
