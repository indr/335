...
public class FloatPreference implements FloatPreferenceType {
  private final SharedPreferences sharedPreferences;
  private final String key;
  private final float defaultValue;

  public FloatPreference(final @NonNull SharedPreferences sharedPreferences, final @NonNull String key) {
