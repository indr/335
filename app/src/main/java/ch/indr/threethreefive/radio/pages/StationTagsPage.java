...
public class StationTagsPage extends SpiceBasePage implements RequestListener<Station[]> {

  private String stationId;

  public StationTagsPage(Environment environment) {
    super(environment);
  ...
  @Override public void onRequestSuccess(Station[] stations) {
    ...
    for (String tag : station.getTags()) {
      builder.addLink("/radio/tags/" + tag, tag);
    }
